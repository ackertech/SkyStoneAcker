...
import org.firstinspires.ftc.teamcode.FTCVuforiaDemo.Robot_OmniDrive;
...
public class Navigation {
    ...
    private static final double  ON_AXIS        =  1;      // Within 1.0 inch of target center-line
    private static final double  CLOSE_ENOUGH   =  2;      // Within 2.0 inch of final target standoff
    ...
    public LinearOpMode myOpMode;       // Access to the OpMode object
    public VizBot myRobot;        // Access to the Robot hardware

    public VuforiaTrackables targetsSkyStone = null;
    public List<VuforiaTrackable> allTrackables = new ArrayList<VuforiaTrackable>();

    public String targetName = null;
    public VuforiaTrackables   targets;        // List of active targets
